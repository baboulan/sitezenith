...
echo "<script>window.location.href='equipment1.php'</script>";
} else {
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<a href="equipmentview.php"><button style="color: dodgerblue;"class="btn btn-primary"><h4 style="color: white">View all Equipments </h4></button></a>
