			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
								<a href="addpurchase.php"><button><h5>Back To Importing</h5></button></a></center> <p>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="deleteimpor.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?')"class="btn btn-primary">Delete</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
