...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "INSERT into employee(id,name,lname,gender,indangamuntu,field,position,joindate,salary) values('','$name','$lname','$gender','$idnumber','$field','$position','$joindate','$salary')");
if($query){
...
<head>
	...
	<title>Daily Expense Tracker || Add Employee</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<center>	<a href="viewemployee.php"><button style="color: dodgerblue;"class="btn btn-primary"><h4 style="color: white;">View Employee </h4></button></a></center> 
