...
<div class='panel panel-default'>
          ...
          <div class='panel-body'>
            ...
            <div class='col-md-12'>
                  <label> Name: </label> <input class='form-control' type='text' name='name' value='" . $row['name'] . "'required readonly><br>
                <input  class='form-control' type='hidden' name='description' value='" . $row['description'] . "'required >
                  <label>Available Quantity</label>: <input class='form-control' type='number' name='quantity' value='" . $row['quantity'] . "' readonly><br>
                  <input class='form-control' type='number' name='remove' placeholder='Amount to reduce'><br>
