...
<body>
  <?php include_once('includes/header.php');?>
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id'])) {
        ...
        $sql = "SELECT * FROM exported WHERE id = $id";
...
<div class='panel panel-default'>
          ...
          <div class='panel-body'>
            ...
            <div class='col-md-12'>
                  <label> Name: </label> <input class='form-control' type='text' name='name' value='" . $row['bname'] . "'required ><br>
...
include('includes/dbconnection.php');
    if(isset($_POST['submit'])){
     ...
     $total=$qua*$price;
     $date=$_POST['date'];
     $qry=mysqli_query($con, "UPDATE  exported set id='$id', ExpenseItem='$name',type='$type', quantity='$qua',ExpenseCost='$price',Total='$total', ExpenseDate='$date' where id='$id'");
     header('location:exreport.php');
