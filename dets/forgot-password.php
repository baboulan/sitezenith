...
if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['email'];
        ...
        $query=mysqli_query($con,"select id  from users where  email='$email' and phone='$contactno' ");
...
<head>
	...
	<title>Site Zenith - Forgot Password</title>
...
<body>
	<div class="row">
			<h2 align="center">Site Zenith</h2>
	<hr />
