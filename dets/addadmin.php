...
if(isset($_POST['submit']))
  {  	
    ...
    $query=mysqli_query($con, "insert into users(id,fullname,username,password,email,phone) value('','$names','$user','$pass','$email','$phone')");
if($query){
			...
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<a href="system.php"><button><h4>Back To Viewing all Admins</h4></button></a></center> <p>
