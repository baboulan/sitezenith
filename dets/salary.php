...
echo "<script>window.location.href='viewsalary.php'</script>";
} else {
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <center>    <a href="viewsalary.php"><button style="color: dodgerblue;"class="btn btn-primary"><h4 style="color: white;">View Salary </h4></button></a></center> 
        <div class="row">
            <div class="col-lg-12">
