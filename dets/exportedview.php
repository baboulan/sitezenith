...
<body>
    ...
    <center>	<a href="searchexp.php"><button style="color: dodgerblue;"class="btn btn-primary"><h4 style="color: white;">Search Report</h4></button></a></center> <p>
						<div class="col-md-12">
								<a href="exported.php"><button><h5>Back To Exporting</h5></button></a></center> <p>
              ...
              <tbody>
                <tr>
                 ...
                 <td><?php  echo $ttlsl=number_format($row['total'],0);?></td>                             
                  ...
                  <td><a href="updateexport.php?id=<?php echo $row['id'];?>" class="btn btn-primary">Edit</a>&nbsp;&nbsp;<a href="deleteexpo.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?')"class="btn btn-primary">Delete</a></td>
                </tr>
                </tr>
                <?php 
$cnt=$cnt+1;
