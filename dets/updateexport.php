...
<div class='panel panel-default'>
          ...
          <div class='panel-body'>
            ...
            <div class='col-md-12'>
                  <label> Name: </label> <input class='form-control' type='text' name='name' value='" . $row['bname'] . "'required readonly><br>
                  Type: <input  class='form-control' type='text' name='type' value='" . $row['type'] . "' ><br>
