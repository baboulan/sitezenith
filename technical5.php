...
<body>
  ...
  <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    echo $msg;
            ...
            <div class="col-md-12">
                <center><a href="technical6.php" ><button class="btn btn-primary"><h4 style="color: white;">Start Reporting</h4></button></a></center> <p>
...
?>
              <tbody>
                <tr>
                  ...
                  <td><a href="deletetexer.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to delete?')"class="btn btn-primary">Remove</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
