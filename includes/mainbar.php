...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        <div class="profile-sidebar">
            ...
            <div class="profile-usertitle">
                ...
                <div class="profile-usertitle-name">&nbsp;&nbsp;<b><?php echo $username; ?></b></div>
                 <div class="profile-usertitle-status">&nbsp;&nbsp;&nbsp;<span class="indicator label-success"></span> as admin</div>
           ...
           <li><a href="viewbudget.php"><em class="fa fa-folder">&nbsp;</em> <b>BUDGET</U></b></a></li>
            <li class="parent "><a data-toggle="collapse" href="#sub-item-1">
                ...
                <ul class="children collapse" id="sub-item-1">
                    ...
                    <li><a class="" href="viewsalary.php">
     ...
     <P> 
         ...
         <li><a href="expenseview.php"><em class="fa fa-plus">&nbsp;</em> <b> EXPENSE</U></b></a></li>
