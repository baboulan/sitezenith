...
$ret=mysqli_query($con,"SELECT tblexpense.ExpenseDate,budget.bname,tblexpense.type,tblexpense.quantity,tblexpense.ExpenseCost,tblexpense.Total
from tblexpense join budget on tblexpense.bname=budget.bid
 where ExpenseDate BETWEEN '$fdate' and '$tdate' order by ExpenseDate asc");
$cnt=1;
